...
import { ChevronLeft, ShieldAlert, Key } from "lucide-react";
    ...
    <div className="flex flex-col h-full w-full bg-stone-50 overflow-y-auto font-sans pb-24">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        >
          ...
          <div className="w-24 h-24 bg-gradient-to-br from-red-100 to-rose-50 rounded-full border-4 border-white shadow-xl flex items-center justify-center relative z-10 mx-auto">
        ...
        >
          セキュリティ保護のため、外部サービスとの接続が一時的に切断されています。<br />
          お手数ですが、アカウントの連携を再設定してください。
        </motion.p>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-stone-800 text-sm mb-1">再連携で解決します</h3>
              <p className="text-xs text-stone-500 leading-relaxed">
                同期設定画面から再度ログインするだけで、元の連携状態に復帰できます。
              </p>
            </div>
          </div>
        </motion.div>
